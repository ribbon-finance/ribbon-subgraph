...
export class YearnVault__strategiesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class YearnVault extends ethereum.SmartContract {
  static bind(address: Address): YearnVault {
    return new YearnVault("YearnVault", address);
  }
  ...
  strategies(arg0: Address): YearnVault__strategiesResult {
    let result = super.call(
      "strategies",
    ...
    return new YearnVault__strategiesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_strategies(
    arg0: Address
  ): ethereum.CallResult<YearnVault__strategiesResult> {
    let result = super.tryCall(
      "strategies",
      "strategies(address):(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(arg0)]
    ...
    return ethereum.CallResult.fromValue(
      new YearnVault__strategiesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
